...
function Nav({ onLaunch, onDocs }: { onLaunch: () => void; onDocs: () => void }) {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "glass border-b border-white/[0.06]" : "bg-transparent"}`}
    >
      <div className="max-w-7xl mx-auto px-5 md:px-10 py-3.5 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-1">
          {["Pipeline", "Agents", "Stack", "Terminal"].map((l) => (
            <a key={l} href={`#${l.toLowerCase()}`} className="px-3 py-2 text-xs font-medium text-white/55 hover:text-white transition-colors">
              {l}
            </a>
          ))}
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={onDocs}
            className="hidden sm:inline-flex font-mono text-[10px] uppercase tracking-[0.12em] px-3 py-2 rounded-md border border-white/10 text-white/70 hover:text-white hover:border-white/25 transition-all"
          >
            Docs
          </button>
          <button
            onClick={onLaunch}
            className="group inline-flex items-center gap-1.5 font-mono text-[10px] uppercase tracking-[0.12em] px-3.5 py-2 rounded-md bg-white text-black hover:bg-white/90 transition-all hover:-translate-y-0.5"
          >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5 md:px-10 w-full grid lg:grid-cols-[1.4fr_1fr] gap-10 items-center">
        <motion.div style={{ y: y1 }}>
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-white/10 bg-white/[0.03] mb-7"
          >
          ...
          <h1 className="font-display font-extrabold tracking-tighter text-white leading-[0.86] text-[clamp(54px,9vw,140px)] mb-7">
            <motion.span initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.05, ease: [0.16, 1, 0.3, 1] }} className="block">
              The OS
            </motion.span>
          ...
          <motion.p
            ...
            className="text-base md:text-lg text-white/55 leading-relaxed max-w-xl mb-10 font-body"
          >
            Give it a goal. It plans, researches, writes code, heals its own errors, scores its
            own work, and delivers a polished answer — completely autonomously.
          </motion.p>
          ...
          >
            <button
              onClick={onLaunch}
              className="group relative inline-flex items-center gap-2 px-6 py-3.5 rounded-xl bg-white text-black font-mono text-xs uppercase tracking-[0.14em] font-semibold overflow-hidden hover:-translate-y-0.5 transition-transform"
            >
            ...
            <button
              className="inline-flex items-center gap-2 px-6 py-3.5 rounded-xl border border-white/15 bg-white/[0.02] text-white font-mono text-xs uppercase tracking-[0.14em] hover:bg-white/[0.05] hover:border-white/25 hover:-translate-y-0.5 transition-all"
            >
        ...
        {/* Right: stat console */}
        <motion.div
          initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 1, delay: 0.4, ease: [0.16, 1, 0.3, 1] }}
          ...
          <div className="relative card-3d rounded-2xl overflow-hidden glass border border-white/10 glow">
            ...
            {[
              ...
              <motion.div
                ...
                className="px-5 py-3.5 border-b border-white/[0.04] hover:bg-white/[0.025] transition-colors"
              >
            ...
            <div className="px-5 py-3 bg-gradient-to-r from-cyan-500/[0.06] via-transparent to-purple-500/[0.06]">
              ...
              <div className="mt-1.5 h-1 rounded-full bg-white/5 overflow-hidden">
                <motion.div
                  initial={{ width: 0 }} animate={{ width: "78%" }} transition={{ duration: 1.6, delay: 1.2 }}
    ...
    <section id="pipeline" className="relative bg-[#050505] py-24 md:py-32 px-5 md:px-10 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        <motion.h2
          ...
          className="font-display font-extrabold tracking-tighter text-white text-[clamp(40px,7vw,84px)] leading-[0.9] mb-12"
        >
          From goal<br />
          <span className="text-white/20">to answer.</span>
        </motion.h2>
          ...
          {STEPS.map((s, i) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -4 }}
                className="group relative p-6 rounded-xl border border-white/[0.07] bg-gradient-to-br from-white/[0.025] to-transparent hover:from-white/[0.05] hover:border-white/15 transition-all overflow-hidden"
              >
            ...
            {PIPE.map((n, i) => (
              <React.Fragment key={n}>
                <div
                  ...
                  style={{
                    borderColor: AGENT_COLORS[n] + "40",
                    background: AGENT_COLORS[n] + "10",
                  }}
                >
          ...
          {AGENTS.map((a, i) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -6 }}
                className="group relative p-7 rounded-2xl border border-white/[0.07] bg-[#0B0B0B] overflow-hidden card-3d"
                style={{ boxShadow: "0 1px 0 rgba(255,255,255,.04) inset" }}
              >
                ...
                <div
                  ...
                  style={{ background: `radial-gradient(circle, ${c}26, transparent 70%)` }}
                />
                ...
                <div className="relative flex items-start justify-between mb-5">
                  <div
                    ...
                    style={{
                      background: `linear-gradient(135deg, ${c}1f, transparent)`,
                      borderColor: c + "40",
                    }}
                  >
                ...
                <div className="flex flex-wrap gap-1.5">
                  {a.tags.map((tg) => (
                    <span
                      key={tg}
                      className="font-mono text-[10px] uppercase tracking-[0.06em] px-2 py-1 rounded-md border"
  ...
  return (
    <section id="stack" className="relative bg-[#050505] py-24 md:py-32 px-5 md:px-10 border-t border-white/[0.05]">
      <div className="max-w-7xl mx-auto">
        ...
        >
          Built with<br />
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-cyan-300 to-blue-500">precision.</span>
        </motion.h2>
          ...
          {STACK.map((col, ci) => {
            ...
            return (
              <motion.div
                ...
                className="group p-5 bg-[#0A0A0A] hover:bg-[#101010] transition-colors"
              >
...
function Terminal() {
  ...
  const stop = () => {
    ...
    setStreaming(false);
    setActiveNode("");
    setMsgs((p) => [...p, { role: "agent", content: "⚠ Run stopped by user.", node: "system" }]);
  };
  ...
  const SidePanel = (
    <div className="bg-[#0A0A0A] border-l border-white/[0.06] flex flex-col min-w-0 h-full">
      {/* Connection */}
      <div className="p-4 border-b border-white/[0.06]">
        <div className="font-mono text-[9px] uppercase tracking-[0.18em] text-white/35 mb-3">Connection</div>
        {!token ? (
          <>
            <input
              value={email}
              ...
              className="w-full bg-[#050505] border border-white/[0.08] rounded-md px-3 py-2 text-white text-xs font-mono outline-none mb-2 focus:border-cyan-400/40 transition-colors"
            />
            <button
              onClick={login}
              disabled={logging}
              className="w-full bg-white text-black rounded-md py-2 font-mono text-[10px] uppercase tracking-[0.12em] font-semibold disabled:opacity-50 hover:bg-white/90 transition"
            >
              {logging ? "Connecting…" : "Get token"}
            </button>
            <div className="font-mono text-[9px] text-white/30 mt-2">Demo mode · any email works</div>
          </>
        ) : (
          <div className="flex items-center gap-2">
            <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 pulse-dot" />
            <span className="font-mono text-[10px] text-emerald-300">Connected</span>
            <button onClick={() => setToken("")} className="ml-auto text-white/40 hover:text-white">
          ...
          {PIPE.map((n) => {
            ...
            return (
              <div
                ...
                style={{
                  borderColor: isA ? c + "55" : "transparent",
                  background: isA ? c + "12" : "transparent",
                }}
              >
                <span
                  className="w-1.5 h-1.5 rounded-full flex-shrink-0 transition-all"
                  style={{
                    background: isA ? c : isD ? "rgba(255,255,255,.5)" : "rgba(255,255,255,.12)",
                    boxShadow: isA ? `0 0 8px ${c}` : "none",
                  }}
                />
                <span
                  className="font-mono text-[11px] capitalize flex-1 transition-colors"
                  style={{ color: isA ? c : isD ? "#fff" : "rgba(255,255,255,.3)" }}
                >
                  {n}
                </span>
  ...
  return (
    <section
      id="terminal"
      className={fullscreen ? "fixed inset-0 z-[100] bg-[#050505]" : "relative bg-[#050505] py-24 md:py-32 px-5 md:px-10 border-t border-white/[0.05]"}
    >
      {!fullscreen && (
        <div className="max-w-7xl mx-auto mb-10">
          ...
          <div className="flex flex-wrap items-end justify-between gap-4">
            <motion.h2
              initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }}
              className="font-display font-extrabold tracking-tighter text-white text-[clamp(40px,7vw,84px)] leading-[0.9]"
            >
              Talk to the<br />
              <span style={{ WebkitTextStroke: "1px rgba(255,255,255,0.22)", WebkitTextFillColor: "transparent" }}>system.</span>
            </motion.h2>
            <button
              onClick={() => setPanelOpen(!panelOpen)}
              className="md:hidden font-mono text-[10px] uppercase tracking-[0.12em] px-3 py-2 rounded-md border border-white/10 text-white/60 hover:text-white"
            >
      ...
      <div className={fullscreen ? "h-full" : "max-w-7xl mx-auto"}>
        <motion.div
          layout
          className={`${fullscreen ? "h-full rounded-none border-0" : "rounded-2xl border border-white/[0.07]"} bg-[#0A0A0A] overflow-hidden glow`}
        >
          {/* Title bar */}
          <div className="flex items-center gap-2 px-4 py-2.5 border-b border-white/[0.06] bg-black/60 backdrop-blur-sm">
            <button onClick={() => setFullscreen(false)} className="group w-3 h-3 rounded-full bg-[#FF5F57] flex items-center justify-center" title="Exit fullscreen">
              <X className="w-2 h-2 text-black/0 group-hover:text-black/70" />
            </button>
            <button onClick={() => setMinimized(!minimized)} className="group w-3 h-3 rounded-full bg-[#FFBD2E] flex items-center justify-center" title="Minimize">
              <Minimize2 className="w-2 h-2 text-black/0 group-hover:text-black/70" />
            </button>
            <button onClick={() => setFullscreen(!fullscreen)} className="group w-3 h-3 rounded-full bg-[#28CA41] flex items-center justify-center" title="Maximize">
              <Maximize2 className="w-2 h-2 text-black/0 group-hover:text-black/70" />
            </button>
            ...
            <div className="ml-auto flex items-center gap-2">
              {streaming && (
                <button
                  onClick={stop}
                  className="flex items-center gap-1 font-mono text-[9px] uppercase tracking-[0.08em] px-2.5 py-1 rounded-md bg-red-500/15 border border-red-500/30 text-red-300 hover:bg-red-500/25 transition"
                >
              ...
              <button
                ...
                className="flex items-center gap-1 font-mono text-[9px] uppercase tracking-[0.08em] px-2.5 py-1 rounded-md border border-white/10 text-white/55 hover:text-white hover:border-white/25 transition"
              >
                {fullscreen ? <><Minimize2 className="w-3 h-3" /> Exit</> : <><Maximize2 className="w-3 h-3" /> Maximize</>}
              </button>
              <button
                onClick={() => setMinimized(!minimized)}
                className="hidden sm:flex items-center gap-1 font-mono text-[9px] uppercase tracking-[0.08em] px-2.5 py-1 rounded-md border border-white/10 text-white/55 hover:text-white hover:border-white/25 transition"
              >
          ...
          <AnimatePresence initial={false}>
            {!minimized && (
              <motion.div
                ...
                className={fullscreen ? "h-[calc(100%-44px)] grid md:grid-cols-[1fr_280px]" : "grid md:grid-cols-[1fr_280px]"}
              >
                {/* Message stream */}
                <div className="flex flex-col bg-[#050505] min-w-0">
                  <div
                    ref={msgsRef}
                    className={`flex-1 overflow-y-auto p-5 space-y-2.5 ${fullscreen ? "" : "min-h-[320px] max-h-[440px]"}`}
                  >
                    {msgs.length === 0 && (
                      <div className="font-mono text-[12.5px] text-white/40 leading-loose">
                        ...
                        <br />
                        <span className="opacity-70">{token ? "Type a goal below to start a run." : "Connect to get started."}</span>
                        <br />
                        <span className="opacity-40 italic">Try: "Research what LangGraph is and write a Python example"</span>
                      </div>
                    )}
                    <AnimatePresence>
                      {msgs.map((m, i) => (
                        <motion.div
                          ...
                          className="rounded-md px-3.5 py-2.5 border"
                          style={{
                            background: m.role === "user" ? "rgba(6,182,212,.06)" : "#0A0A0A",
                            borderColor: m.role === "user" ? "rgba(6,182,212,.25)" : "rgba(255,255,255,.06)",
                          }}
                        >
                          {m.role === "agent" && m.node && m.node !== "system" && (
                            <div className="font-mono text-[9px] uppercase tracking-[0.14em] mb-1" style={{ color: AGENT_COLORS[m.node] || "#94A3B8" }}>
                              [{m.node}]
                            </div>
                          )}
                  ...
                  {/* Input */}
                  <div className="flex gap-2 p-3 border-t border-white/[0.06] bg-black/30">
                    <input
                      value={goal}
                      onChange={(e) => setGoal(e.target.value)}
                      onKeyDown={(e) => e.key === "Enter" && send()}
                      placeholder={token ? "Type a goal… (Enter to run)" : "Connect first →"}
                      disabled={!token || streaming}
                      className="flex-1 min-w-0 bg-[#0A0A0A] border border-white/[0.08] rounded-md px-3.5 py-2.5 text-white text-[13px] font-mono outline-none focus:border-cyan-400/40 transition disabled:opacity-60"
                    />
                    <button
                      onClick={send}
                      disabled={!token || !goal.trim() || streaming}
                      className="flex-shrink-0 w-11 h-11 rounded-md bg-white text-black flex items-center justify-center disabled:opacity-30 hover:scale-105 transition-transform"
                    >
  ...
  return (
    <div className="min-h-screen bg-[#050505] pt-28 pb-24 px-5 md:px-10">
      <div className="max-w-3xl mx-auto">
        <button
          onClick={onBack}
          className="inline-flex items-center gap-2 font-mono text-[10px] uppercase tracking-[0.12em] px-3 py-2 rounded-md border border-white/10 text-white/55 hover:text-white hover:border-white/25 mb-12 transition"
        >
        ...
        <h1 className="font-display font-extrabold tracking-tighter text-white text-[clamp(48px,8vw,96px)] leading-[0.9] mb-14">
          AgentFlow OS<br />
          <span className="text-white/25">Docs</span>
        </h1>
  ...
  return (
    <footer className="relative bg-black border-t border-white/[0.05] overflow-hidden">
      ...
      <div className="overflow-hidden border-t border-white/[0.04] py-6">
        <div className="flex w-max ticker">
          {[...Array(6)].map((_, i) => (
            <span key={i} className="font-display font-extrabold text-[clamp(60px,10vw,140px)] tracking-tighter text-white/[0.04] px-8 whitespace-nowrap">
              AGENTFLOW · OS ·
            </span>
          ))}
        </div>
